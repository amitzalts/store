...
exports.getStudentGradesInCourse = exports.deleteCourse = exports.updateCourse = exports.addCourse = exports.getOneMovie = exports.seatStatus = void 0;
var ordersModel_1 = require("../orders/ordersModel");
...
exports.getOneMovie = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var movieId, movie, seats, movieOrders, _loop_1, _i, seats_1, seat, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                seats = _a.sent();
                return [4 /*yield*/, ordersModel_1["default"].find({ movieId: movieId })];
            case 3:
                movieOrders = _a.sent();
                _loop_1 = function (seat) {
                    if (movieOrders.some(function (order) { return order.seatIds.includes(seat._id); })) {
                ...
                res.send({ movie: movie, seats: seats });
                return [3 /*break*/, 5];
            case 4:
                error_1 = _a.sent();
...
exports.addCourse = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, course, studentId, student, courseDB, students, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 5, , 6]);
                _a = req.body, course = _a.course, studentId = _a.studentId;
                return [4 /*yield*/, StudentModel.findById(studentId)];
            case 1:
                student = _b.sent();
                if (!student)
                    throw new Error("no student found");
                return [4 /*yield*/, CourseModel.create({ name: course })];
            case 2:
                courseDB = _b.sent();
...
exports.updateCourse = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, courseId_1, studentId, updatedCourse, student, course, updatedCourseDB, _course, students, error_3;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 6, , 7]);
            ...
            case 1:
                ...
                if (!student)
                    throw new Error("no student found");
                return [4 /*yield*/, CourseModel.findById(courseId_1)];
            case 2:
                course = _b.sent();
                if (!course)
                    throw new Error("no course found");
                return [4 /*yield*/, CourseModel.updateOne({ courseId: courseId_1 }, { name: updatedCourse })];
            case 3:
...
exports.deleteCourse = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, courseId_2, studentId, student, course, courseIndex, students, error_4;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 5, , 6]);
            ...
            case 1:
                ...
                if (!student)
                    throw new Error("no student found");
                return [4 /*yield*/, CourseModel.findById(courseId_2)];
            case 2:
                course = _b.sent();
                if (!course)
                    throw new Error("no course found");
...
exports.getStudentGradesInCourse = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var courseName_1, gradesInCourse, _a, _b, student, matchingCourse, e_1_1, error_5;
    var e_1, _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 1:
                ...
                _a = __asyncValues(StudentModel.find());
                _d.label = 2;
